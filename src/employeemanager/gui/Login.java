...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(errResultLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE)
                .addGap(12, 12, 12))
        );
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        // Кнопка Login
        pass = String.valueOf(this.passField.getPassword()); // т.к. getPassword() возвращает тип char 
                                                             // мы конвертируем его в String
        username = this.usernameField.getText();
        if (username.equals("qwe") && pass.equals("as")){
            Main mainWindow = new Main();
            mainWindow.setVisible(true); // открывает окно Main
            setVisible(false); // закрывает текущее окно
        }else{
            this.errResultLabel.setText("Wrong username or password");
        }   
    ...
    private void passFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_passFieldKeyPressed
        // event/событие на нажатие нопки Enter:
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
            this.errResultLabel.setText("hello");
//            Main mainWindow = new Main();
