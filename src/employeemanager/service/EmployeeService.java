...
public class EmployeeService {
        ...
        // добавление emp в БД через EmployeeDao
        public static void add(Employee emp) throws SQLException{
            EmployeeDao empDao = new EmployeeDao();
            empDao.add(emp);
        }
        
        public static void edit(Employee emp) throws SQLException{
            EmployeeDao empDao = new EmployeeDao();
            empDao.edit(emp);
        }
        
        //передача emp в окно Edit
        public static Employee getByParams(String name, String surname, String position) {
            return empDao.getEmployee(name, surname, position);
        }
